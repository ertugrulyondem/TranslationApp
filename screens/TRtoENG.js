...
const App = () => {
  ...
  function postTranslationApp(text) {
    fetch('https://translate.yandex.net/api/v1.5/tr.json/translate?key=trnsl.1.1.20200420T131946Z.5db1a66c6b35ba2c.890156e28f69bf7314b3d824b76054579360c154&lang=tr-en&text=' + text)
      .then((res) => res.json())
      .then((res) => {
